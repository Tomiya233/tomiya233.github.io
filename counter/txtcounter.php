...
$visiblet = "no";			// (Un)Sichtbarkeit des Totalcounters
$visibled = "no";			// (Un)Sichtbarkeit des Heutecounters
$visibley = "no";			// (Un)Sichtbarkeit des Vortagcounters
$visibler = "no";			// (Un)Sichtbarkeit des Rekordcounters
$visibleo = "no";			// (Un)Sichtbarkeit des Onlinecounters
...
$txttotal = "All Time: ";			// Text vor der Gesamtbesucheranzahl
